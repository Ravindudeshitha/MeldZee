...
import image2 from './assets/screen.png';
...
const F2DAnnotator = () => {
  ...
  return (
    <div className="bg-gray-100">
        ...
        <section className="bg-slate-900 text-white py-50">
            <div className="container mx-auto text-center">
                <h1 className="text-5xl font-bold mb-6">Download F2F Annotator</h1>
                <p className="text-lg mb-8">Fast and simple tool to download files and YouTube videos with ease!</p>
                <a href="https://drive.google.com/uc?export=download&id=1p1trldHPmwDuBRvvYJ_4OLMcEPgatu1A" >
        ...
        <section className="py-20 bg-gray-200 text-gray-800">
            <div className="container mx-auto flex items-center justify-between px-4">
                ...
                <div className="w-full md:w-1/2">
                    <h1 className="text-4xl text-right font-bold mb-6">What is F2F Annotator?</h1>
                    <p className="text-lg text-right mb-6">
                    F2F Annotator is a versatile tool for easy image and graph annotation. 
                    It allows you to annotate using edges and nodes, just like a graph. Additionally, you can create bounding boxes in various shapes, including L, T, I, and X. Perfect for tasks like object detection and shape recognition, F2F Annotator offers an efficient and flexible way to add precise annotations.
